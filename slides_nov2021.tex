...
\subtitle{Letras - Inglês}
\date{\today}
%\author{\texttt{-Autor- MarkOlson.SE}}
\institute{ LET/IL/UnB \par \small}
...
\begin{frame}{NDE vs. Colegiado de Área}

Resumindo: 
\begin{itemize}
\item o NDE tem atribuições de formulação e acompanhamento do curso; 
\item o Colegiado de Curso tende a ter um papel administrativo.
\end{itemize} 
\end{frame}
